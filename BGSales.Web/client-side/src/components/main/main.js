            ...
            { className: "info" },
            {
              children: _jsx(
                ...
                __assign(
                  ...
                  {
                    children:
                      "Thanks to this site, many media personalities were able to get decent pay, and advertisers gained new customers through advertising media personalities.",
                  }
                ),
                void 0
              ),
          ...
          __assign(
            { className: "button-container" },
            {
              children: _jsx(
                ...
                __assign(
                  {
                    className: "button-container__pressed",
                    to: "/authorization",
                  },
                  { children: "Start now" }
                ),
